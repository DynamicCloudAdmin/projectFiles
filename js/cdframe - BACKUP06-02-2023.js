        ...
        if (WhatAction == "SAVEMODULESETNOW") {
            ...
            if (DemoOrNot == "DEMO") {
                ...
                for (i = 1; i < (rows.length); i++) {
                    ...
                    var ThisTenant = rows[i].getElementsByTagName("td")[2].innerHTML;

                    var AllIDsNow = ThisModNameInTable + ":" + ThisTarget + ":" + ThisTenant;
        ...
        if (WhatAction == "ADDMODULESSET") {
            ...
            if (DemoOrNot == "DEMO") {
                ...
                if (SelModTypeNow == "Default Set") {
                    ...
                    ThisModAssOrNot = "Assessment Set";
                }
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            if (data.message) {
                                ...
                                function FunctionFooterDIV() {
                                    document.getElementById("ThisMSGFooter").style.marginBottom = "-1000px";
                                    clearInterval(MyTimerFooter);
                                }
                    ...
                    for (var i = 0; i < rows.length; i++) {
                        ...
                        if (CheckFRow == "" || CheckFRow == null) {} else {
                            ...
                            if (CheckFRow == "Set Name") {
                                ...
                                ModuleToModify = cells[0];
                                var ReplDataN = ModuleToModify.replaceAll(' ', "_") + ":" + cells[2].replaceAll(' ', "_") + ":" + cells[3].replaceAll(' ', "_") + ":" + cells[4].replaceAll(' ', "_") + ":" + cells[5].replaceAll(' ', "_") + ":" + cells[6].replaceAll(' ', "_");
            ...
            if (data.message) {
                ...
                for (var i = 0; i < cells.length; i++) {
                    ...
                    cell.onclick = function() {
                        ...
                        if (result) {
                            document.getElementById("ThisLoadedMSetNR").innerHTML = "Modules Set:" + TemplateName + "|" + "Default Set";
                        } else {
                            document.getElementById("ThisLoadedMSetNR").innerHTML = "Modules Set:" + TemplateName + "|" + "Assessment Set";
                        }
                ...
                for (var i = 0; i < rows.length; i++) {
                    ...
                    if (cells.length > 1) {
                        ...
                        if (newcell == 'Unique Name') {
                            ...
                            var ButTestAccountID = '<button id="' + ThisTenNameNow + '"' + ' class = "TableButtonHoverClass" onclick="TestSPNFunction(id)" style="font-size: 11px; background: white; border-radius: 8px; font-weight: 500; border: 1px solid; padding: 8px; cursor: pointer; letter-spacing: 0px; color: rgb(6, 115, 168);">Test Accounts</button>'
                            var cell = row.insertCell(-1);
                ...
                for (var i = 0; i < rows.length; i++) {
                    ...
                    if (ThisViewName == "" || ThisViewName == null) {} else {
                        ...
                        if (ThisViewName == FinalViewName) {
                            ...
                            var StrNew = VStartColID + "," + VEndColID + "," + VChartTypeID + "," + VChartDataTypeID + "," + VChartUpdateID + "," + VChartTypeID + "," + ViewSETNameDivID + "," + MAINPanelTitle + "," + MAINPanelTitleCheckBox + "," + MAINPanelUPDownID + "," + MAINSetExpandID;
                            var row = datatableVIEW.insertRow(-1);
...
$("#GoLeftForModPaneAndRight").click(function(e) {
    ...
    if (TotW < 45) {
        //document.getElementById('AVDFullMenuDiv').setAttribute("style", "width:342px");
        document.getElementById('MAINNOWAllModulesTableDivHere').style.width = "20%";
    }
    if (TotW > 340) {
                ...
                for (var i = 0; i < rows.length; i++) {
                    ...
                    if (ThisViewName == "" || ThisViewName == null) {} else {
                        ...
                        if (ThisViewName == FinalViewName) {
                            ...
                            var thisString = ` <div id="ID_VIEWSETNAME" style="transition: 0.8s; width: 473px;height: 438px;margin-top: 8px;margin-left: 0px;border: 1px solid #d5d5d5;border-radius: 0px;padding: 10px;box-shadow: none;padding-top: 2px;float: left;padding-bottom: 34px;padding-left: 0px;padding-right: 0px;" class="AllDivsAnimationNow">
                            <div style="background: #37475f;border-radius: 0px;margin-top: -11px;height: 26px;margin-left: 0px;">
...
<button id="ID_MENUEXPAND" class="OfficeButton AllDivsAnimationNow" style="
padding: 0px;
padding-left: 10px;
...
<button id="ID_MENUUPDOWN" class="OfficeButton AllDivsAnimationNow" style="
padding: 0px;
padding-left: 10px;
padding-right: 10px; /*! border: 2px solid #ca7d2c; */
background: white;
...
<button id="ID_VIEWREFRESH" class="OfficeButton AllDivsAnimationNow" style="
padding: 0px;
padding-left: 10px;
padding-right: 10px; /*! border: 2px solid #ca7d2c; */
background: white;
...
<div id="ID_VPANEL" style="display: none; height: 224px; border: 1px solid rgb(149, 145, 145); width: 300px; overflow: hidden; border-radius: 0px;background: white;position: fixed;z-index: 99;right: 0;margin-right: 12px;box-shadow: rgb(218, 221, 223) 6px 5px 11px;border-radius: 0px 5px 5px 5px;" class="AllDivsAnimationNow" data-highcharts-chart="3">

<div style="display: inline-block;float: none;border-bottom: 2px solid #dfdbdb;width: 100%;height: 64px;" class="AllDivsAnimationNow">

                                
<p id="ID_VIEWLASTUPDATED" style="margin: 0px;font-size: 8px;font-family: &quot;Roboto&quot;;font-weight: 500;color: #8c8c8c;padding-top: 3px;padding-left: 7px;display: block;background: white;border-radius: 0px !important;padding-bottom: 3px;padding-left: 10px;padding-right: 10px;border-bottom: 1px solid #dbd2d2;height: 22px;" class="AllDivsAnimationNow">VIEWMODLASTUPDATED</p>
<p id="ID_CLOSEPANELMENU" style="float: right;font-size: 11px;margin-top: -24px;color: red;border: 1px solid #d0cbcb;height: 24px;padding-left: 5px;padding-right: 5px;cursor: pointer;margin-right: -1px;background: #f7f3f3;color: red;padding-top: 3px;border-radius: 0px;font-weight: 600;z-index: 100;position: fixed;right: 0;">X</p>
...
<i class="far fa-check-circle" aria-hidden="true" style="padding-right: 5px; padding-top: 5px"></i>Update Chart
            ...
            <div style="border: 1px solid #dbd4d4;border-radius: 5px;margin-top: 10px;margin-top: 10px;width: 42%;height: 28px;margin-left: 23px;background: #f6f8f9;margin-left: auto;margin-right: auto;">
<input type="checkbox" id="vehicle3" name="vehicle3" value="Boat" style="margin-left: 11px;font-size: 12px;" onclick="ProcessTitleCheckBoxFunction()">
<label for="vehicle3" style="margin: 0px;padding: 0px;padding-left: 3px;font-size: 12px;color: #686565;font-weight: 600;margin-left: auto;margin-right: auto;">Hide main title</label>  

</div>
</div>

                            <div id="ID_TIT_LE" style="/*! display: inline-block; *//*! float: none; *//*! margin-left: 0px; *//*! position: fixed; */height: 17px;border-bottom: 1px solid #e6e3e3;">

<p id="ID_WHICHMODULE" style="font-size: 9px;padding: 0px;/*! margin: 0px; */background: #ffeaea;color: #605f5f;text-align: left;text-transform: capitalize;font-weight: 600;/*! border-radius: 5px; *//*! margin-top: -17px; *//*! padding-left: 7px; *//*! display: inline-block; *//*! display: inline-block; */margin-top: 1px;font-style: italic;margin-bottom: 0px;">VIEW_SETMODULENAME</p>
</div>
<div id="ID_VIEWTABLE" style="background: white; height: 327px; overflow: auto; display: block;width: 100%;height: 100%;" class="AllDivsAnimationNow"></div>
                            ...
                            var result = Thistext.replaceAll("VIEW_SETMODULENAME", ModuleAndTen).replaceAll("80", ViewStartCol)
                                ...
                                .replaceAll("ID_CLOSEPANELMENU", MAINMenuPanelCloseID);
                            //var result = Thistext;
...
function RemoveItemFromSetFunction(ThisobjectToRemove) {

    var ThisobjectToRemove = ThisobjectToRemove.replaceAll("_", " ");
    MSGNow = "Remove current item from Modules Set: " + ThisobjectToRemove;
    document.getElementById("ConfirmDBox").style.display = "block";
    document.getElementById("TakeActionMSG").innerHTML = MSGNow;
    document.getElementById("ActionDoWhat").innerHTML = "RemoveSingleItemNow";
    document.getElementById("ForMultiStringID").innerHTML = "RemoveSingleModule:" + ThisobjectToRemove;
...
$("#RefAllTenants").click(function(e) {
    ...
    document.getElementById("TenantDIV").innerHTML = InsertC;
